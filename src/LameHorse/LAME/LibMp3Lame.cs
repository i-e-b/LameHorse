...
namespace LameHorse
{
	...
	public class LibMp3Lame : IDisposable
	{
		...
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_set_errorf(IntPtr lame_global_flags, LameInfoCallback func);

		// int CDECL lame_set_debugf(lame_global_flags *, lame_report_function);
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_set_debugf(IntPtr lame_global_flags, LameInfoCallback func);

		// int CDECL lame_set_msgf  (lame_global_flags *, lame_report_function);
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_set_msgf(IntPtr lame_global_flags, LameInfoCallback func);

		// int CDECL lame_set_brate(lame_global_flags *, int);
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_set_brate(IntPtr lame_global_flags, int brate);
		...
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_set_quality(IntPtr lame_global_flags, int quality);
		...
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_encode_buffer(IntPtr lame_global_flags,
											 short[] buffer_l,
											 short[] buffer_r,
											 int nsamples,
											 IntPtr mp3buf,
		...
		[DllImport("libmp3lame.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern int lame_get_lametag_frame(IntPtr lame_global_flags, IntPtr buffer, int size);
