...
namespace FlacDecode
{
	public class AudioBuffer
	{
		...
		public AudioBuffer(FlakeReader source, int _size)
		{
			pcm = source.PCM;
			size = _size;
		}
		...
		{
			get { return length*pcm.BlockAlign; }
		}
		...
		public void Prepare(FlakeReader source, int maxLength)
		{
